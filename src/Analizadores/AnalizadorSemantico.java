...
public class AnalizadorSemantico {
    ...
    /**
     * Retorna el árbol sintáctico solo en el caso de que no haya habido error
     * durante el análisis semántico.
     *
     * @return ArbolSintactico si fue validado semánticamente y no hubo errores
     * @throws Error en caso de que haya habido algún error semántico durante el
     * análisis
     */
    ...
    private void analizarSecuencia(NodoSintactico inicioSecuencia, ArrayList<Variable> variablesGlobales) {
        ...
        if (!variablesGlobales.isEmpty()) {
            variablesDeclaradas.addAll(variablesGlobales);
        }

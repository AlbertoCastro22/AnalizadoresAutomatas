...
public class AnalizadorLexico {
    ...
    /**
     * Analiza si un determinado Token pertenece al léxico. Imprime mensaje de
     * error si no pertenece.
     *
     * @param ingreso objeto Token a validar
     * @return Tokens.ERROR si no forma parte del lexico, otro Tokens si
     * pertenece
     */
    public Tokens analizarToken(Token ingreso) {
        ...
        switch (token) {
            ...
            case "+=":
                ...
                break;
            case "-=":
                t = Tokens.MENOSNUMERO;
                break;
            case "*=":
                t = Tokens.PORNUMERO;
                break;
            case "/=":
                t = Tokens.DIVIDIDONUMERO;
                break;
            case "++":
                t = Tokens.MASUNO;
                break;
    ...
    /**
     * Esta función arma el siguiente token del ingreso asignado al analizador y
     * valida que sea del léxico.
     *
     * @return Tokens.Error si el token pertenece al léxico, otro Tokens caso
     * contrario; Tokens.EOT si ya se recorrió todo el ingreso
     * @throws NullPointerException en caso de que no se haya asignado ingreso
     * al analizador
     */
